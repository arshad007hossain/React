...
export default class LatestPhotos extends Component {
    ...
    componentDidMount() {
        axios.get('https://api.unsplash.com/photos/?client_id=qgb54sO_0iKlTvMi11inHJXTuE60sI_V4KwahNDlHp0&per_page=16&page='+ this.state.page).then(
            res => this.setState({
                photos: res.data,
                loading: false,
    ...
    searchTrigger = (e) => {
        ...
        axios.get('https://api.unsplash.com/photos/?client_id=qgb54sO_0iKlTvMi11inHJXTuE60sI_V4KwahNDlHp0&query=' + this.state.search_query + '&per_page=16&page='+ this.state.page).then(
            res => this.setState({
